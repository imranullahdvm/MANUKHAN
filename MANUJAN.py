...
\033[1;96mYT╔══M4╗B4║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░NO CHANNEL╔╝
...
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█IMRAN█╗░░██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
...
def menu():
    ...
    os.system('echo  HI, I AM IMRAN ULLAH A ETICAL HACKER | lolcat -a -F 0.1')
    ...
    os.system('echo  VISIT OUR YOUTUBE CHANNEL NO CHANNEL | lolcat -a -F 0.1')
    ...
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  IMRAN HACKER| lolcat --animate')
    ...
    os.system('echo -----------------IM----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 MANUJAN.py| lolcat --animate')
    os.system('echo -----------------IMRAN ULLAH----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [L]  Install MANIKHAN Clonnig----------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  IMRAN ULLAHWhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                time.sleep(5)
                os.system("cd $HOME/Attacker && python2 MANUJAN.py")
